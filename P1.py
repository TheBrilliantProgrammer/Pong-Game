...
pygame.display.set_caption("Pong Game (1 Player)")
...
def control():
    ...
    if keys[pygame.K_UP]:
        paddle2.moveUp(5)
        paddle1.moveUp(paddle1.rect.top-ball.rect.top+random.randint(15, 20))
    if keys[pygame.K_DOWN]:
        paddle2.moveDown(5)
        paddle1.moveDown(ball.rect.top-paddle1.rect.top)
